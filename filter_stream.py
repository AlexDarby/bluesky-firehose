...
# Define keywords for filtering; leave empty to display all posts
KEYWORDS = ["sunday"]
...
def worker_main(cursor_value: multiprocessing.Value, pool_queue: multiprocessing.Queue) -> None:
    ...
    while True:
        ...
        for created_post in ops[models.ids.AppBskyFeedPost]['created']:
            ...
            # Extract post text and apply keyword filtering
            inlined_text = record.text.replace('\n', ' ')
            if not KEYWORDS or contains_keyword(inlined_text, KEYWORDS):
